...
const PhysicalTherapyRecord = () => {
  ...
  const getData = async () => {
        try {
          ...
          const jsonValue = await AsyncStorage.getItem('@pt')
          let data = null
          if (jsonValue!=null) {
  ...
  const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@pt', jsonValue)
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={{fontSize:12}}>
          Enter the info for your current physical therapy exercise below
      </Text>
...
export default PhysicalTherapyRecord;